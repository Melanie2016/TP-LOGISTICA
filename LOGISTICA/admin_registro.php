  ...
  <div class="container">
  	...
  	<form class="form-signin" method="POST" action="admin_registro.php"  >
		...
		<div class="input-group">
			...
			<input type="text" name="id" class="form-control" placeholder="ingrese ID aqu&iacute" aria-describedby="basic-addon1"  autofocus value=<?php if(isset($id))echo $id; ?>>
		</div>
		
		<!-- NOMBRE -->
		<div class="input-group">
			<span class="input-group-addon" id="basic-addon1">Nombre</span>
			<input type="text" name="nombre" class="form-control" placeholder="ingrese nombre aqu&iacute" aria-describedby="basic-addon1"  autofocus value=<?php if(isset($nombre))echo $nombre; ?>>
		</div>
		
		<!-- APELLIDO -->
		<div class="input-group">
			<span class="input-group-addon" id="basic-addon1">Apellido</span>
			<input type="text" name="apellido" class="form-control" placeholder="ingrese apellido aqu&iacute" aria-describedby="basic-addon1" autofocus value=<?php if(isset($apellido))echo $apellido; ?>>
		</div>
		
		<!-- DNI -->
		<div class="input-group">
			<span class="input-group-addon" id="basic-addon1">DNI</span>
			<input type="text" name="dni" class="form-control" placeholder="ingrese DNI aqu&iacute" aria-describedby="basic-addon1" autofocus value=<?php if(isset($dni))echo $dni; ?>>
		</div>
		
		<!-- ROL -->
		<div class="input-group">
			<span class="input-group-addon" id="basic-addon1">Rol</span>
			<input type="text" name="rol" class="form-control" placeholder="ingrese rol aqu&iacute;" aria-describedby="basic-addon1" autofocus value=<?php if(isset($rol))echo $rol; ?>>
		</div>
		...
		<div class="input-group">
			...
			<input type="text" name="area" class="form-control" id="basic-url" placeholder="ingrese area aqu&iacute;" aria-describedby="basic-addon3" autofocus value=<?php if(isset($area))echo $area; ?>>
		...
		<div class="input-group">
			...
			<input type="text" name="licencia" class="form-control" id="basic-url" placeholder="ingrese licencia aqu&iacute;" aria-describedby="basic-addon3" autofocus value=<?php if(isset($licencia))echo $licencia; ?>>
		</div>
		
		<!-- MATRICULA -->
		<div class="input-group">
			<span class="input-group-addon" id="basic-addon3">Matricula</span>
			<input type="text" name="matricula" class="form-control" id="basic-url" placeholder="ingrese matricula aqu&iacute;" aria-describedby="basic-addon3" autofocus value=<?php if(isset($matricula))echo $matricula; ?>>
		</div>
		...
		<div class="input-group">
			...
			<input type="text" name="usuario" class="form-control" id="basic-url" placeholder="ingrese usuario aqu&iacute;" aria-describedby="basic-addon3"  autofocus value=<?php if(isset($usuario))echo $usuario; ?>>
		</div>
   ...
   <center><a href="admin_empleados.php"> Volver </a> </center>
</body>
▼</html>
