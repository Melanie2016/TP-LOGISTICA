  ...
  <a href="admin_registro.php"><button class="btn" type="button">Registrar empleado</button></a>
   <br><br>
	...
	while($row=mysqli_fetch_array($result)) {
		...
		echo "<TD>&nbsp;" . $row["dni"] . "</TD>";	
		echo"<td><a href='abm.php?accion=modificacion'><button class=btn  type=button> Modificar </button></a></td>";
		echo"<td><a href='abm.php?accion=baja'><button class=btn  type=button >Eliminar </button></a></td>";
   	}
